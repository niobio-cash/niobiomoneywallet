...
namespace WalletGui {
    ...
    bool NodeAdapter::init() {
        ...
        if (connection.compare("embedded") == 0) {
            ...
            m_node = createRpcNode(CurrencyAdapter::instance().getCurrency(), *this, localNodeUrl.host().toStdString(),
                                   localNodeUrl.port());
            QTimer initTimer;
            ...
            m_node = createRpcNode(CurrencyAdapter::instance().getCurrency(), *this, remoteNodeUrl.host().toStdString(),
                                   remoteNodeUrl.port());
            QTimer initTimer;
